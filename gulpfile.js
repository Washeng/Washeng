...
gulp.task( 'sass', function() {
      return gulp.src( ['src/scss/*.scss'] )  //后缀为scss
...
gulp.task('default', function () {
    //监听的文件    监听的任务
    watch(['src/html/*.html', 'src/scss/*.scss', 'src/js/*.js','src/img/*.png','src/scss/*.scss'], gulp.parallel('uglifyhtml', 'runsass', 'babel','runimg','sass'));
